...
async function cadastraCliente(dados) {
    ...
    let finalizou = false;
    try {
        resultado = await conexao.query(`INSERT INTO USUARIO(cpf,nome,sobrenome,email,telefone,senha,genero,estado,cep,cidade,rua,numero,complemento,bairro,aceito_termos_de_condicao,receber_notificacoes,receber_emails,estado_civil,como_soube_do_site,celular,datanascimento)
